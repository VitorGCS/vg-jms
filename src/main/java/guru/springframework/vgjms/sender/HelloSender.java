...
public class HelloSender {
    ...
    @Scheduled(fixedRate = 2000)
    public void endandRecieveMessage() throws JMSException {
        HelloWorldMessage message = HelloWorldMessage.builder()
                .id(UUID.randomUUID())
                .message("Hello")
                .build();
        ...
        Message receiveMsg = jmsTemplate.sendAndReceive( JmsConfig.MY_SEND_RCV_QUEUE, new MessageCreator() {
            ...
            public Message createMessage(Session session) throws JMSException {
                ...
                try {
                    ...
                    helloMessage.setStringProperty("_type", "guru.springframework.vgjms.model.HelloWorldMessage");
        ...
        System.out.println(" ------->>>> Message received: "+receiveMsg.getBody(String.class));
    }
}
